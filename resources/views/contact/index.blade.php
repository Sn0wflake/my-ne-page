        ...
        <div class="grid md:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="flex space-x-4 mb-8">
                    <a href="https://t.me/konvirehitus" class="bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600">
                    ...
                    <a href="https://facebook.com/yourpage" class="bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto my-auto" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <p>PVN Reg.Nr.LV 40203397226</p>
                        <p>Citadele bank</p>
                        <p>LV82PARX0127834569012</p>
                    </div>
                </div>
            </div>
